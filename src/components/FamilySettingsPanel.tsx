      ...
      <div className="rounded-lg border border-gray-200 p-4">
        ...
        <div className="mt-2 flex flex-wrap items-center gap-2">
          ...
          <button
            type="button"
            onClick={handleCopy}
            className="rounded-md border border-gray-300 px-3 py-1.5 text-sm transition hover:bg-gray-50 active:scale-95"
          >
            {copied ? "コピーしました" : "コピー"}
          </button>
          {isOwner ? (
            <button
              ...
              className="rounded-md border border-gray-300 px-3 py-1.5 text-sm transition hover:bg-gray-50 active:scale-95 disabled:opacity-50 disabled:active:scale-100"
            >
